            ...
            <View style={styles.bg}>
                <ViewPagerAndroid
                    ...
                    <View style={styles.container}>
                        <Image source={require('../images/guide01.jpg')} style={styles.image}/>
                    ...
                    <View style={styles.container}>
                        <Image source={require('../images/guide02.jpg')} style={styles.image}/>
                        <Text style={styles.welcome}>
                            人生不断向前的秘诀{'\n'}
                            就是忘记从那里来 记得到哪里去
                        </Text>
                    ...
                    <View style={styles.container}>
                        <Image source={require('../images/guide03.jpg')} style={styles.image}/>
                        <Text style={styles.welcome}>
                            人生路虽漫长{'\n'}
                            但是关键的就那几步
                        </Text>
                    ...
                    <View style={styles.container}>
                        <Image source={require('../images/guide04.jpg')} style={styles.image}/>
                        
                        <TouchableNativeFeedback
                            onPress={this.onPressButton}
                            background={TouchableNativeFeedback.SelectableBackground()}>
                          <View style={{width: 200,height:40,backgroundColor:'#fff',justifyContent:'center'}}>
                              <Text style={styles.welcome}>
                                欢迎使用逗比APP
                             </Text>      
                          </View>
